            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#add_administrativos" id="boton" data-whatever="@mdo"><i class="fa fa-plus"></i>&nbsp; Agregar</button>
