...
<script type="text/javascript">
  cargarMatDoc("<? echo $id_grupo; ?>");
        ...
        <select name='aula' id='aula' tipo="2" class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true">
        	<option value="0">Sin Aula adicional</option>
        </select>
        </div>
