<div class="modal fade" id="add_academia" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
	<div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-academia" action="php/add_academiasE.php" method="post" enctype="multipart/form-data">
              <div class="row">
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      add("#form-academia","Listado de academia");
      $successMsg.show();
      return false; 
    }
  });
