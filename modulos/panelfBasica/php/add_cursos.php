<div class="modal fade" id="add_cursos" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
	<div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-cursos" action="php/add_cursosE.php" method="post" enctype="multipart/form-data">
              <div class="row">
              <div class="form-group col-sm-6">
               ...
               <div class="form-group col-sm-6">
                <label>* Carrera:</label>
                <select name='carrera' id='carrera' class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona carrera" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione una carrera</b>">
                </select>
                </div>
              <div class="form-group col-sm-6">
                <label>* Estatus:</label>
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      add("#form-cursos","Listado de módulo");
      $successMsg.show();
      return false; 
    }
  });
