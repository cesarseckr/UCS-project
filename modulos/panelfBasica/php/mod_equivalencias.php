<div class="modal fade" id="mod_equivalencias" tabindex="-1" role="dialog" aria-labelledby="mod" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-edit"></i>&nbsp; Modificar equivalencia
        </h5>
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-equivalencias_m" action="php/mod_equivalenciasE.php" method="post" enctype="multipart/form-data">
...
<script>
  $successMsg = $(".alert");
  $.validate({
    form : '#form-equivalencias_m',
    modules : 'security',
    errorMessageClass: "error",
    onSuccess: function(){
      mod("#form-equivalencias_m","Listado de equivalencias");
      $successMsg.show();
      return false; 
    }
  });
