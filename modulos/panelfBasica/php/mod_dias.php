<div class="modal fade" id="mod_dias" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-edit"></i>&nbsp; Modificar Día
        </h5>
      ...
      <div class="modal-body">
            ...
            <form id="form-dias_m" action="php/mod_diasE.php" method="post" enctype="multipart/form-data">
              <div class="row">
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      mod("#form-dias_m", "Listado de dias");
      $successMsg.show();
      return false;
    }
  });
