    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-edit"></i>&nbsp; Modificar Administrativo
        </h5>
      ...
      <div class="modal-body">
            ...
            <form id="form-adm_m" action="php/mod_administrativosE.php" method="post" enctype="multipart/form-data">
             ...
             <div class="form-group col-sm-6">
              ...
              <div class="form-group col-md-12">
              <h3>Informacion del inistrativo</h3><hr>
          </div>
            <div class="form-group col-sm-6"> 
             ...
             <div class="form-group col-sm-4">
                <label>Email:</label>
                <input type="text" class="form-control" placeholder="Email" name="email_m" id="email_m">
              </div>
             ...
             <div class="form-group col-sm-12">
                <label>* Area:</label>
                <select name='area_m' id='area_m'class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona una área" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione una área</b>">
                </select>
              </div>
              <div class="form-group col-sm-12"> 
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      mod("#form-adm_m", "Listado de administrativos");
      $successMsg.show();
      return false; 
    }
  });
