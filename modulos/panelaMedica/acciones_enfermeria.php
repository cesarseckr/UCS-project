...
<body>
  ...
  <div class="container-scroller">
    ...
    <?php 
		  // MODALS //
      include("php/add_acciones_enfermeria.php");
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-lg-12 grid-margin">
          <div class="card">
            <div class="card-body"><h4 class="card-title"><i class="menu-icon fas fa-laptop-medical"></i>&nbsp; ACCIONES DE ENFERMERÍA</h4><hr>
              <div class="fluid-container">
                ...
                <? include("php/tabla_acciones_enfermeria.php"); ?>                 
              </div>
            </div>
          </div>
        </div>
