          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                    <i class="fa fa-file-pdf"></i> Reporte de Morbilidad (incidencia por sistema)
                  </h4>
                  <div class="form-row">
                    <div class="form-group col-4">
                      <form action="pdf/reporte_mobilidad_si.php" method="post" enctype="multipart/form-data" target="_blank">
                        <? 
