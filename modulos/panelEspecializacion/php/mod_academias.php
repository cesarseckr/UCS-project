<div class="modal fade" id="mod_academias" tabindex="-1" role="dialog" aria-labelledby="mod" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-edit"></i>&nbsp; Modificar Curso
        </h5>
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-academias_m" action="php/mod_academiasE.php" method="post" enctype="multipart/form-data">
...
<script>
  $successMsg = $(".alert");
  $.validate({
    form : '#form-academias_m',
    modules : 'security',
    errorMessageClass: "error",
    onSuccess: function(){
      mod("#form-academias_m","Listado de academias");
      $successMsg.show();
      return false; 
    }
  });
