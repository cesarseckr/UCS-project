<div class="modal fade" id="add_carreras" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
	<div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-carreras" action="php/add_carrerasE.php" method="post" enctype="multipart/form-data">
              <div class="row">
              ...
              <div class="form-group col-sm-6">
                ...
                <select name='academia' id='academia' class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona modalidad" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione un Modalidad</b>">
                </select>
                </div>
                <div class="form-group col-sm-6">
                <label>* Tipo de carrera:</label>
                <select name='tipo_area' id='tipo_area' class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona tipo de carrera" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione un tipo de carrera</b>">
                </select>
                 </div>
              <div class="form-group col-sm-6">
                <label>* Estatus:</label>
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      add("#form-carreras","Listado de carreras");
      $successMsg.show();
      return false; 
    }
  });
