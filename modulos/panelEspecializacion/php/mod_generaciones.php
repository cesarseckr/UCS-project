<div class="modal fade" id="mod_generaciones" tabindex="-1" role="dialog" aria-labelledby="mod" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-edit"></i>&nbsp; Modificar Generación
        </h5>
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-generaciones_m" action="php/mod_generacionesE.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group col-sm-6">
                ...
                <select name='academia_m' id='academia_m' class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona modalidad" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione una modalidad</b>">
                </select>
                </div>
                 <div class="form-group col-sm-6">
                <label>* Estatus:</label>
...
<script>
  $successMsg = $(".alert");
  $.validate({
    form : '#form-generaciones_m',
    modules : 'security',
    errorMessageClass: "error",
    onSuccess: function(){
      mod("#form-generaciones_m","Listado de generaciones");
      $successMsg.show();
      return false; 
    }
  });
