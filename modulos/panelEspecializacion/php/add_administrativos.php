      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <div class="form-group col-sm-6"> 
             ...
             <div class="form-group col-sm-12">
                <label>* Area:</label>
                <select name='area' id='area'class="selectpicker form-control" data-live-search="true" data-live-search-normalize="true" title="Selecciona una área" data-validation="required" data-validation-error-msg="<b style='color:red;'>Seleccione una área</b>">
                </select>
              </div>
              <div class="form-group col-sm-12"> 
...
<script>
  ...
  $.validate({
    ...
    onSuccess: function(){
      add("#form-adm","Listado de administrativos");
      $successMsg.show();
      return false; 
    }
  });
