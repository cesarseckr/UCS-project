<div class="modal fade" id="add_equivalencias" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-plus"></i>&nbsp; Nueva Equivalencia
        </h5>
      ...
      <div class="modal-body">
          <div class="form-row">
            ...
            <form id="form-equivalencias" action="php/add_equivalenciasE.php" method="post" enctype="multipart/form-data">
              <div class="row">
...
<script>
  $successMsg = $(".alert");
  $.validate({
    form : '#form-equivalencias',
    modules : 'security',
    errorMessageClass: "error",
    onSuccess: function(){
      add("#form-equivalencias","Listado de equivalencias");
      $successMsg.show();
      return false; 
    }
  });
