<nav class="sidebar sidebar-offcanvas noprint" id="sidebar">
 ...
 <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#calendarios" aria-expanded="false" aria-controls="evaluaciones">
              <i class="menu-icon fa fa-calendar-alt"></i>
              <span class="menu-title">Calendarios</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="calendarios">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="calendario.php">  <i class="menu-icon far fa-calendar-alt"></i>&nbsp; Formación básica</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="calendario_esp.php"><i class="menu-icon far fa-calendar-alt"></i>&nbsp; Educación continua</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="grupos.php"> <i class="fa fa-users"></i>&nbsp; Grupos</a>
                    ...
                    <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#evaluaciones" aria-expanded="false" aria-controls="evaluaciones">
            ...
            <div class="collapse" id="evaluaciones">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="calificaciones.php"> <i class="fa fa-list-ol"></i>&nbsp; Listado de calificaciones</a>
                </li>
              </ul>
            </div>
          </li>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="documentos">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="reporte_bitacoras.php"> <i class="fa fa-clipboard-list"></i>&nbsp; Bitácora de calificaciones</a>
                </li>
                <li class="nav-item">
