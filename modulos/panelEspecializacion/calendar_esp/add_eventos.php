...
.color1::-webkit-color-swatch-wrapper {
  ...
  padding: 5;
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btnAgregar_esp"><i class="fa fa-play-circle"></i>Agregar</button>
        <button type="button" class="btn btn-primary" id="btnModificar_esp"><i class="fa fa-play-circle"></i>Modificar</button>
        <button type="button" class="btn btn-danger" id="btnBorrar_esp"><i class="fa fa-trash-alt"></i>Borrar</button>
