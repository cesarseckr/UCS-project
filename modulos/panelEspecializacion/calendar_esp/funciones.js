    ...
    anio: {
      ...
      buttonText: 'Año'
        ...
        events:'calendar_esp/add_eventosE.php',
        editable:true,
        disableResizing: false,
        durationEditable: true,
        dayClick: function(date, jsEvent,view){
			var btnAgregar_esp = document.getElementById("btnAgregar_esp");
	 			btnAgregar_esp.style.display= "inline";
	 		var btnModificar_esp = document.getElementById("btnModificar_esp");
	 			btnModificar_esp.style.display= "none";
	 		var btnBorrar_esp = document.getElementById("btnBorrar_esp");
	 			btnBorrar_esp.style.display= "none";
		...
		eventClick: function(calEvent,jsEvent,view){
			var btnAgregar_esp = document.getElementById("btnAgregar_esp");
				btnAgregar_esp.style.display= "none";
			var btnModificar_esp = document.getElementById("btnModificar_esp");
				btnModificar_esp.style.display= "inline";
			var btnBorrar_esp = document.getElementById("btnBorrar_esp");
				btnBorrar_esp.style.display= "inline";
			var txtId_usuario = document.getElementById("txtId_usuario");
			...
			$.ajax({
				type:'POST',
				url:'calendar_esp/nombre_usuario.php',
      ...
      var NuevoEvento;
		$('#btnAgregar_esp').click(function(){
			RecolectarDatosGUI();
			EnviarInformacion('agregar',NuevoEvento);
		});

		$('#btnBorrar_esp').click(function(){
			RecolectarDatosGUI();
			EnviarInformacion('eliminar',NuevoEvento);
		});

		$('#btnModificar_esp').click(function(){
			RecolectarDatosGUI();
		...
		function EnviarInformacion(accion,objEvento,modal){
			$.ajax({
				type:'POST',
				url:'calendar_esp/add_eventosE.php?accion='+accion,
				data:objEvento,
				success:function(data){
