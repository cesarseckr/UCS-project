            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr>
                  <? include("php/add_grupos.php"); ?>
                  <? include("php/add_periodos.php"); ?>
                  <? include("php/mod_grupos.php"); ?>
                  <? include("php/materias_grupos.php"); ?>
                  <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#add_grupos" id="boton" data-whatever="@mdo"><i class="fa fa-plus"></i>&nbsp; Agregar</button>
                  <form><div class="form-row">
                  <div class="form-group col-sm-12">
                  <hr><b>Busqueda de grupos</b><br>
