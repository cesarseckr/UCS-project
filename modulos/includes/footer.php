        <footer class="footer">
          <div class="container-fluid clearfix">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Version de desarrollo
...
<!-- plugins:js -->
  ...
  <script src="../includes/js/tablas.js"></script>
  <script src="../includes/js/alertas.js"></script>
  ...
  <script src="../../js/bootstrap-select/js/i18n/defaults-es_ES.min.js"></script>
</body>
